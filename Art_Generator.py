...
current_dir = os.path.dirname(os.path.realpath('ArtGen.py'))

content_image = scipy.misc.imread(os.path.join(current_dir,'Images/Content.jpg'))

style_image = scipy.misc.imread(os.path.join(current_dir,'Images/Style.jpg'))
...
if __name__ == "__main__":
    ...
    style_image_resized = Image_size_optimizer(style_image,"Style")
    ...
    J_content = compute_content_cost(a_C, a_G)
    sess.run(model['input'].assign(style_image_resized))
